...
function SponsorForm() {
    ...
    return (
        ...
        >
            ...
            >
            {isBrowser &&
            <h1 className="form_heading">Sponsor at Markoknow.</h1>
            }
            {isMobile &&
            <h1 className="form_heading">Sponsor at us.</h1>
            }
            <p className="partner_para">Be the partner with Markoknow by Sponsor{isMobile && <br/>} our Event.</p>
            <br/>
            ...
            <input type="text" value={about1} onChange={e => setAbout1(e.target.value)} class="action_input1 " required placeholder="How do you want to sponsor our events?" />
            <input type="text" value={about2} onChange={e => setAbout2(e.target.value)} class="action_input1 " placeholder="What do you want to achieve by sponsoring our events?" />
            <br/>
            <label className="file_input">Upload Document:
            <input className="file_input" key={input_val} onChange={handleFile} type="file" size="large" />
            </label>
            <br/>
            <button type="submit" value={"sponsor"} onClick={(e)=>{onSubmit(e,"value")}} class="action_btn1">Submit</button>
            </form>
